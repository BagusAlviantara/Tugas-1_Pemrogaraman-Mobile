...
//untuk menampung parameter detail produk yang dikirim list produk
  DetailProduk(
...
class _DetailProdukState extends State<DetailProduk> {
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < widget.star; i++) {
      //memasukkan icon star ke variabel children.star
    ...
    //widget Scanffold sebagai isi halaman
    return Scaffold(
      //app bar
      appBar: new AppBar(
      ...
      body: new Container(
        ...
        child: new ListView(
          //adapun isi didalamnya dibungkus children
          children: <Widget>[
            Column(
              children: <Widget>[
